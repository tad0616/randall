...
define("WMNHI_TF_SHOW_VAR", "Do you want to display the set of variables?");
define("WMNHI_TF_SHOW_VAR_DESC", "Do you want to display the set of variables?");
define("WMNHI_SITENAME_FONT_FAMILY", "CSS for site title");
define("WMNHI_SITENAME_FONT_FAMILY_DESC", "CSS for site title");
define("WMNHI_SLOGAN_FONT_FAMILY", "CSS for site slogan");
define("WMNHI_SLOGAN_FONT_FAMILY_DESC", "CSS for site slogan");
